...
public class VelocityProperties extends ServiceProperties{
    
    public VelocityProperties(File file, int maxplayers, int port, String motd, boolean proxyProtocol, boolean onlineMode) {
        super(file, "velocity.toml", port);
            ...
            new String[]
                {
                    "# Config version. Do not change this\n",
                        ...
                        "forwarding-secret = \"m4Il6EyIva5I\"\n",
