package de.polocloud.internalwrapper.impl.manager.screen.impl;
...
public class SimpleScreen extends Thread implements IScreen {
    ...
    public void run() {
        ...
        while (this.running) {
            try {
                ...
                if (InternalWrapper.getInstance().getWrapperConfig().isLogServerScreens()) {
    ...
    public void setPrinter(ConsoleExecutor console) {
        ...
        this.screenManager = InternalWrapper.getInstance().getScreenManager();
    }
