...
import de.polocloud.internalwrapper.impl.manager.server.ServiceStarter;
        ...
        if (cached != null) {
            ...
            try {
                ...
                serviceStarter.start(server -> {
                    ...
                    if (InternalWrapper.getInstance().getScreenManager().getScreen() != null && InternalWrapper.getInstance().getScreenManager().isInScreen()) {
                        return;
                    }
