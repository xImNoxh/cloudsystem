...
public enum SignState {
    ...
    /**
     * The {@link de.polocloud.signs.sign.base.IGameServerSign sign} has no set {@link IGameServer}
     * (Also the default value)
     */
    LOADING(),

    /**
     * The {@link IGameServer} has reached the maximum player count
     * of the {@link de.polocloud.api.template.base.ITemplate}
     */
    FULL(),

    /**
     * The {@link IGameServer} of the {@link de.polocloud.signs.sign.base.IGameServerSign} is online
